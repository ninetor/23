		...
		<div class="page-table-wrap">
			<div class="page-table">
				<div class="page-table__row">
					<div class="page-table__cell"><strong>Название</strong></div>
					<div class="page-table__cell"><strong>Описание бонуса</strong></div>
					<div class="page-table__cell centered"><strong>Стоимость, баллов</strong></div>
				</div>
				<div class="page-table__row">
					<div class="page-table__cell">Бонус код «World of Tanks 50 gold»</div>
					<div class="page-table__cell">50 игрового золота</div>
					<div class="page-table__cell centered"><span class="points">200</span></div>
				</div>
				<div class="page-table__row">
					<div class="page-table__cell">Бонус код «World of Tanks 100 gold»</div>
				...
				<div class="page-table__row">
					...
					<div class="page-table__cell centered"><span class="points">800</span></div>
				</div>
				<div class="page-table__row">
					<div class="page-table__cell">Бонус код «World of Tanks 1 день премиум»</div>
					<div class="page-table__cell">1 день премиум-аккаунта</div>
					<div class="page-table__cell centered"><span class="points">800</span></div>
				</div>
				<div class="page-table__row">
					<div class="page-table__cell">Инвайт-код World of Tanks</div>
					<div class="page-table__cell">Инвайт-код (для новых игроков):<br> Премиум танк T-127 + 3 дня<br> премиум-аккаунта</div>
					<div class="page-table__cell centered"><span class="points">100</span></div>
				</div>
			</div>
		</div>
		<p>
			<strong class="definition">Золото</strong> &mdash; один из основных ресурсов игры World of Tanks: его можно использовать для обучения членов экипажа, покупки премиум-техники, премиум-снарядов, снаряжения и др.
		</p>
		<p>
			<strong class="definition">Премиум-аккаунт</strong> даёт 50%-ный прирост заработанных кредитов и опыта за каждый бой, а значит, позволяет быстрее достичь желаемой боевой машины в дереве развития и экономит необходимое на прокачку время.
		</p>
		<p>
			<strong class="definition">Инвайт-код</strong> &mdash; бонусный код, которым могут воспользоваться только новые игроки (те, кто не был ранее зарегистрирован в World of Tanks).
		</p>
	</div>
	<div class="question-list">
		<div class="question-item">
			<div class="question-link">Как отправить «боевой подарок» (бонусный код World of Tanks) себе или другу?</div>
			<div class="question-answer">
				Чтобы отправить уникальный код на «боевой подарок» нужно:
				<ol>
					<li>
					...
					<li>
						Далее ввести номер телефона абонента-получателя, которому вы хотите отправить уникальный код.
					</li>
					<li>
						После этого на указанный номер абонента-получателя придет SMS-оповещение с уникальным кодом и поздравлением от абонента-отправителя: тот, кому отравлен бонус-код, будет знать, от кого пришёл подарок.
					</li>
				</ol>
			</div>
			<i></i>
	...
	<div class="question-list">
		<div class="question-item">
			...
			<div class="question-answer">
				<ul>
					<li>
						Написать оригинальное обоснование, почему лучше подарить танк, а не банальный подарок, на ресурсе <a href="http://tanki.mts.by" target="_blank">tanki.mts.by</a>, введя собственный оригинальный текст в специальную форму. Длина текста не должна превышать 90 символов кириллицей с учетом пробелов и знаков препинания.
					</li>
					<li>
						Оформить заявку на участие в конкурсе, указав в специальной форме свой номер телефона, фамилию и имя. Данные будут использоваться для того, чтобы связаться с победителем для последующего вручения приза.
					</li>
					<li>
						Отправить созданную запись при помощи сервиса tanki.mts.by в социальную сеть <a href="https://www.facebook.com/" target="_blank">Facebook</a> или <a href="https://vk.com" target="_blank">ВКонтакте</a>
					</li>
				</ul>
			</div>
			<i></i>
